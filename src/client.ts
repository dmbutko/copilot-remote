...
export interface Client {
  ...
  sendDraft?(chatId: string, draftId: number, text: string, opts?: MessageOptions): Promise<'ok' | 'transient' | 'permanent'>;
  ...
  onReaction?: (emoji: string, chatId: string, msgId: number, threadId?: number) => Promise<void>;
  onFile?: (
    fileId: string,
    fileName: string,
    caption: string,
